...
public class ApiUrl {
    public static final String BASE_URL = "http://apextechies.com/softgalli/index.php/";
    ...
    public static final String GET_ADMISSION_LIST = BuildConfig.WEBSITE_URL + "apis/getAdmissionList.php";
