...
public class StudentsFragment extends Fragment {
    ...
    private void initView() {
        ...
        Utilz.showLog(TAG, "initView method is called : " + tabTitle + ", " + mClassName);
    ...
    private void getStudentListFromServer() {
        ...
        retrofitDataProvider.getStudentsListByClassWise(mActivity, mClassName, mSectionName, new DownlodableCallback<StudentListByClassModel>() {
            @Override
    ...
    public void callStudentListFromServer(String tabTitle, String mClassName) {
        ...
        manageVisibility();
        Utilz.showLog(TAG, "callStudentListFromServer method is called : " + tabTitle + ", " + mClassName);
        if (!isCallingApi) {
