...
public class HomeScreenActivity extends AppCompatActivity
    ...
    @BindView(R.id.upcomingActHeaderTv)
    TextView upcomingActHeaderTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manageForceUpgradeAppDialog();
    }

    private void manageForceUpgradeAppDialog() {
        String newAppVersion = ClsGeneral.getStrPreferences(AppConstants.APP_VERSION_PLAY_STORE), currentAppVersion = BuildConfig.VERSION_CODE + "";
        Utilz.showLog(TAG, "New App version : " + newAppVersion + ", currentAppVersion : " + currentAppVersion);
        if (!newAppVersion.equalsIgnoreCase(currentAppVersion)) {
            ...
            Utilz.updateAppDialog(mActivity, msg);
        }
    }
    ...
    private void upcomingEventsHandling() {
        isApiCalling = true;
        retrofitDataProvider.getEventsOrNoticeList(mActivity, true, new DownlodableCallback<EventsAndNoticeLisrModel>() {
            @Override
            public void onSuccess(final EventsAndNoticeLisrModel result) {
                ...
                if (result != null && (AppConstants.TRUE).contains(result.getStatus())) {
                    ...
                    if (!upcomingEventsArrayList.isEmpty()) {
                        ...
                        upcomingActHeaderTv.setVisibility(View.VISIBLE);
                    } else {
                        upcomingActHeaderTv.setVisibility(View.GONE);
                    }
                }
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.principal_zone) {
            ...
            try {
                ...
                Uri uri = Uri.parse(BuildConfig.FACEBOOK_LINK);
                startActivity(new Intent(Intent.ACTION_VIEW, uri));
            } catch (Exception e) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(BuildConfig.FACEBOOK_LINK)));
            }
            ...
            Utilz.openBrowser(mActivity, BuildConfig.WEBSITE_URL);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.admissionRl:
                startActivity(new Intent(HomeScreenActivity.this, QuizQuesCategoryActivity.class));
                break;
            case R.id.galleryRl:
