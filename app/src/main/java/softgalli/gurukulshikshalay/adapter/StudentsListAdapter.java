...
import softgalli.gurukulshikshalay.activity.AddUpdateDeleteStudentActivity;
            ...
            viewHolder.mainView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (v != null && v instanceof LinearLayout) {
                        ...
                        Intent studentIntent = new Intent(mActivity, AddUpdateDeleteStudentActivity.class);
