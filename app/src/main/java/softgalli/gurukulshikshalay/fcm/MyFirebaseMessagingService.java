package softgalli.gurukulshikshalay.fcm;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Utilz.showLog(TAG, "From: " + remoteMessage.getFrom());
        Utilz.showLog(TAG, "From: " + remoteMessage);

        // Check if message contains a data payload.
        if (remoteMessage.getData().size() > 0) {
            Utilz.showLog(TAG, "Message data payload: " + remoteMessage.getData());
        }

        // Check if message contains a notification payload.
        if (remoteMessage.getNotification() != null) {
            Utilz.showLog(TAG, "Message Notification Body: " + remoteMessage.getNotification().getBody());
        }
        ...
        sendNotification(remoteMessage.getNotification().getBody(), remoteMessage.getData().get("shopID"), remoteMessage
                .getData().get("title"));
    }
    // [END receive_message]
